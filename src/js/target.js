...
class Target{
	...
	draw(){
		...
		this.ellipses = [
			{"h": this.pos.x, "k": this.pos.y, "rx" : 14, "ry": 40, "color" : "whitesmoke"},
			{"h": this.pos.x-4, "k": this.pos.y, "rx" : 10, "ry": 33, "color" : "#80bfff"},
			{"h": this.pos.x-7, "k": this.pos.y, "rx" : 7, "ry": 21, "color" : "#ff1a1a"},
			{"h": this.pos.x-10, "k": this.pos.y, "rx" : 4, "ry": 11, "color" : "yellow"}
		];
